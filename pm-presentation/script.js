document.addEventListener('DOMContentLoaded', () => {
  ...
  const sdgData = {
    '1': {
      ...
      desc: "Projects targeting financial literacy, micro-enterprise training for local youths, and skills acquisition schemes. This resolves through local entrepreneurship summits and vocational training."
    },
    '2': {
      title: "SDG 2: Zero Hunger",
      desc: "Community agricultural advocacy, food security campaigns, and food bank donation systems. Important for rural outreach programs and local NGOs."
    },
    '3': {
      title: "SDG 3: Good Health & Well-being",
      desc: "Malaria eradication, immunization support, mental health awareness, and sanitation initiatives. A staple of community health and wellness projects."
    },
    '4': {
    ...
    '6': {
      ...
      desc: "Installing boreholes in rural water-scarce areas, training on hygiene, and construction of toilet facilities."
    },
    '8': {
      title: "SDG 8: Decent Work & Economic Growth",
      desc: "Providing professional internships, CV writing bootcamps, vocational training, and tech skills acquisitions for local youth."
    },
    '13': {
      title: "SDG 13: Climate Action",
      desc: "Tree planting campaigns to curb desertification, waste recycling seminars, and clean-up exercises."
    }
  };
  ...
  const ganttData = {
    'initiation': {
      ...
      desc: "Perform needs assessments, stakeholder interviews, align with strategic project goals, draft project charter, and secure initial approvals."
    },
    'planning': {
      title: "Weeks 2 - 4: Planning & Design",
      desc: "Formulate timeline milestones, prepare budget and financial sponsorships, allocate team resources, and execute outreach strategy."
    },
    'execution': {
      title: "Weeks 4 - 6: Execution & Deliverables",
      desc: "Coordinate project teams, manage community campaigns, run events on the ground, and manage sponsorships and partnerships."
    },
    'closure': {
  ...
  const orgData = {
    'director': {
      ...
      responsibilities: [
        "Liaises with project sponsors, steering committee, and advisory board.",
    ...
    'planner': {
      name: "Project Secretary / Coordinator",
  ...
  function calculateImpact() {
    ...
    let rating = "Local Project Impact";
    if (score > 40) rating = "Moderate Social Impact Project";
    if (score > 65) rating = "High Impact Strategic Project";
    if (score > 85) rating = "Outstanding Global Best Practice Standard";
  ...
  const canvasBlockInfo = {
    'problem': {
      ...
      desc: "Specify the community issues you are tackling (e.g., poor sanitation, youth unemployment in Northern Nigeria). <b>Project Example:</b> High youth unemployment due to lack of standard tech skills."
    },
    'beneficiaries': {
      title: "2. Target Beneficiaries & Segment",
      desc: "Exactly who benefits from the project and who pays/sponsors (e.g., undergraduates in Kaduna). <b>Project Example:</b> 100 students of Ahmadu Bello University, Zaria."
    },
    'value': {
      title: "3. Unique Value Proposition",
      desc: "What unique benefit does this project deliver that others don't? <b>Project Example:</b> Fully funded hands-on mentoring bootcamps featuring industry tech leaders."
    },
    'activities': {
      title: "4. Core Activities & Interventions",
      desc: "The critical actions needed to execute the project. <b>Project Example:</b> Curriculum design, tutor hire, 8-week code bootcamps, and a tech career fair."
    },
    'partners': {
      title: "5. Key Partners & Stakeholders",
      desc: "External bodies crucial for success (government, companies, media). <b>Project Example:</b> State Tech Hub (venue sponsor) and local software development firms."
    },
    'resources': {
      title: "6. Key Resources",
      desc: "What assets (funding, volunteers, material, logistics) are required? <b>Project Example:</b> Laptops, internet plans, team trainers, and sponsorship seed capital."
    },
    'channels': {
      title: "7. Channels & Community Engagement",
      desc: "How do you reach beneficiaries and report back to sponsors? <b>Project Example:</b> Radio announcements, campus flyer runs, digital communities, and press releases."
    },
    'costs': {
      title: "8. Cost Structure",
      desc: "The principal expenditures incurred. <b>Project Example:</b> Venue generator fuel, printing certificates, publicity banners, and trainer stipend."
    },
    'revenue': {
      title: "9. Sustainability & Reinvestment (Surplus)",
      desc: "How to fund the project and recycle surpluses. <b>Project Example:</b> Corporate CSR sponsorships, ticket sales for tech fair, and alumni community contributions."
    },
    'impact': {
      title: "10. Social Impact & Metrics",
      desc: "The systemic change you want to observe (KPIs). <b>Project Example:</b> Number of youths employed, increase in income brackets, and local business partnerships formed."
    }
  };
